...
namespace Akaryakit_Otomasyonu
{
    public partial class Form1 : Form
    {
        ...
        double D_benzin95 = 0, D_benzin97 = 0, D_dizel, D_eurodizel = 0, D_lpg = 0; //D depo
        double E_benzin95 = 0, E_benzin97 = 0, E_dizel, E_eurodizel = 0, E_lpg = 0; // E eklenen
        double F_benzin95 = 0, F_benzin97 = 0, F_dizel, F_eurodizel = 0, F_lpg = 0; //F fiyatlar
        double S_benzin95 = 0, S_benzin97 = 0, S_dizel, S_eurodizel = 0, S_lpg = 0; //S satılan
        ...
        private void prograssBar_guncelle()
        {
